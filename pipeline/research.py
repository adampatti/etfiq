...
# ---------------------------------------------------------------- pages
STYLE = R.RAIL_CSS + R.FOOTER_CSS + """nav.rel{display:flex;flex-wrap:wrap;gap:8px;margin:10px 0 18px}nav.rel a{border:1px solid #DFDCD4;border-radius:999px;padding:6px 12px;background:#fff;font-size:13px;text-decoration:none;color:#14171A}nav.rel a:hover{border-color:#1A4E8A}body{margin:0;background:#F2F1ED;color:#14171A;font:16px/1.6 Geist,system-ui,-apple-system,'Segoe UI',sans-serif}main{max-width:920px;margin:0 auto;padding:28px 20px 60px}.eyebrow{font:600 11px/1 Geist,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#5F625E}h1{font-family:'Source Serif 4',Charter,'Iowan Old Style',Georgia,serif;font-weight:600;font-size:33px;letter-spacing:-.008em;margin:8px 0 8px;line-height:1.15}.dek{font-size:18.5px;line-height:1.5;color:#454842;margin:0 0 22px}.sum p{font-size:17.5px;line-height:1.55;margin:0 0 12px}.narr{border-left:2px solid #1A4E8A;background:#fff;padding:14px 18px 16px;border-radius:0;margin:18px 0}.narr .lab{font:600 11px/1 Geist,sans-serif;letter-spacing:.06em;text-transform:uppercase;color:#5F625E;margin-bottom:8px}h2{font-size:19px;margin:30px 0 10px;letter-spacing:-.01em}table{border-collapse:collapse;width:100%;font-size:14px;background:#fff;border:1px solid #E0DDD5;border-radius:3px}th,td{text-align:left;padding:8px 10px;border-bottom:1px solid #EDEBE4;vertical-align:top}th{font:600 10.5px/1 Geist,sans-serif;letter-spacing:.06em;text-transform:uppercase;color:#5F625E;background:#F7F6F2}td:not(:first-child),th:not(:first-child){text-align:right;font-variant-numeric:tabular-nums}.note{color:#5F625E;font-size:13.5px;margin-top:24px}.cta{display:inline-block;margin:10px 0 0;padding:9px 14px;background:#1A4E8A;color:#fff;border-radius:3px;text-decoration:none;font-weight:600}nav.list a{display:block;padding:14px 16px;border:1px solid #E0DDD5;border-radius:3px;background:#fff;margin:10px 0;color:#14171A;text-decoration:none}nav.list b{display:block;font-size:18.5px;font-family:'Source Serif 4',Charter,'Iowan Old Style',Georgia,serif;font-weight:600;letter-spacing:-.008em}nav.list span{color:#5F625E;font-size:14.5px;line-height:1.45}.wrap{overflow-x:auto}footer{margin-top:40px;color:#5F625E;font-size:13px}"""
