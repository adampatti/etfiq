...
STYLE = R.RAIL_CSS + R.FOOTER_CSS + """pre.embed{background:#0F1419;color:#EDEBE4;padding:14px 16px;border-radius:3px;overflow-x:auto;font:12.5px/1.6 ui-monospace,SFMono-Regular,Menlo,monospace;white-space:pre-wrap;word-break:break-all}dl.faq{margin:0 0 8px}dl.faq dt{font-weight:600;margin:18px 0 6px}dl.faq dd{margin:0;color:#43463F}nav.rel{display:flex;flex-wrap:wrap;gap:8px;margin:10px 0 6px}nav.rel a{border:1px solid #DFDCD4;border-radius:999px;padding:6px 12px;background:#fff;font-size:13.5px;text-decoration:none;color:#14171A}nav.rel a:hover{border-color:#1A4E8A}nav.rel.out a::after{content:' \\2197';color:#5F625E}thead th .sub{font-weight:400;font-size:12px;color:#5F625E;margin-top:4px;max-width:220px}body{margin:0;background:#F2F1ED;color:#14171A;font:15px/1.5 Geist,system-ui,-apple-system,'Segoe UI',sans-serif}main{max-width:820px;margin:0 auto;padding:28px 20px 60px}h1{font-family:'Source Serif 4',Charter,'Iowan Old Style',Georgia,serif;font-weight:600;font-size:31px;letter-spacing:-.008em;line-height:1.15;margin:18px 0 8px}nav.list a b{font-family:'Source Serif 4',Charter,'Iowan Old Style',Georgia,serif}.lede{color:#454842;font-size:16px}.tk{font-family:'Geist Mono',ui-monospace,monospace;font-weight:600}.cta{display:inline-block;margin:14px 0 22px;padding:10px 16px;background:#1A4E8A;color:#fff;border-radius:3px;text-decoration:none;font-weight:600}table{border-collapse:collapse;width:100%;margin:12px 0 18px;font-size:14px}th,td{text-align:left;padding:8px 10px;border-bottom:1px solid #E0DDD5;vertical-align:top}th{color:#454842;font-weight:500}table.kv tbody th{width:42%}table.cmp tbody th{width:26%;white-space:normal}table.cmp thead th{width:37%}main.doc.wide{max-width:1120px}nav.list{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(320px,100%),1fr));gap:12px;margin:14px 0 20px}nav.list a{display:block;padding:16px 18px;border:1px solid #DFDCD4;border-radius:3px;background:#fff;text-decoration:none;color:#14171A}nav.list a:hover{border-color:#1A4E8A}nav.list a .lvl{display:block;font:600 10.5px/1 Geist,system-ui,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#1A4E8A;margin-bottom:8px}nav.list a b{display:block;font-size:16px;line-height:1.3;letter-spacing:-.01em;margin-bottom:6px}nav.list a span{display:block;color:#454842;font-size:13.5px;line-height:1.45}table.pairs td{white-space:normal}table.pairs td:last-child{display:flex;flex-wrap:wrap;gap:5px}table.pairs td a{display:inline-block;padding:3px 8px;border:1px solid #E0DDD5;border-radius:999px;font-size:12px;white-space:nowrap;text-decoration:none;color:#14171A;background:#fff}table.pairs td a:hover{border-color:#1A4E8A}table.pairs td .more{color:#5F625E;font-size:12px;align-self:center}.filterbox{display:flex;gap:8px;max-width:460px;margin:8px 0 16px}.filterbox input{flex:1;padding:10px 12px;border:1px solid #C6C2B8;border-radius:3px;font:14px Geist,system-ui,sans-serif}nav.crumb{font-size:12.5px;color:#5F625E;margin:2px 0 14px;display:flex;flex-wrap:wrap;gap:6px;align-items:center}nav.crumb a{color:#1A4E8A;text-decoration:none}nav.crumb a:hover{text-decoration:underline}nav.crumb b{color:#C6C2B8;font-weight:400}nav.crumb span{color:#14171A;font-weight:600}table.hub th:first-child,table.hub td:first-child{width:70px;white-space:nowrap}table.hub th:nth-child(3),table.hub td:nth-child(3){width:86px}table.hub td:nth-child(2){min-width:210px}table.hub td,table.hub th{white-space:normal}table.hub .tk{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-weight:600}.note{color:#5F625E;font-size:13px}nav.desks a{margin-right:14px}footer{margin-top:40px;color:#5F625E;font-size:13px}"""
