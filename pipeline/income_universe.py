...
OVERRIDES = {  # ticker: dict of fields to force
    'KLIP': {'benchmark': 'KWEB', 'benchmarkName': 'China internet (KWEB)', 'benchmarkKind': 'index'},
    'HYTI': {'benchmark': 'HYG', 'benchmarkName': 'US high yield bonds (HYG), used as the proxy', 'benchmarkKind': 'proxy'},
    'LQTI': {'benchmark': 'LQD', 'benchmarkName': 'US investment grade bonds (LQD), used as the proxy', 'benchmarkKind': 'proxy'},
    'FIYY': {'benchmark': 'TLT', 'benchmarkName': '20+ year Treasuries (TLT)', 'benchmarkKind': 'index'},
    'CSHI': {'benchmark': 'BIL', 'benchmarkName': '1-3 month T-bills (BIL)', 'benchmarkKind': 'index'},
    'BIOY': {'benchmark': 'XBI', 'benchmarkName': 'Biotech (XBI), used as the proxy', 'benchmarkKind': 'proxy'},
    'NVYY': {'benchmark': 'UNG', 'benchmarkName': 'Natural gas (UNG), used as the proxy', 'benchmarkKind': 'proxy'},
    'HYBL': {'benchmark': 'HYG', 'benchmarkName': 'US high yield bonds (HYG), used as the proxy', 'benchmarkKind': 'proxy'},
    'YQQQ': {'benchmark': 'QQQ', 'benchmarkName': 'Nasdaq-100 (QQQ)', 'benchmarkKind': 'index'},
    'NUKX': {'benchmark': 'URA', 'benchmarkName': 'Uranium and nuclear (URA), used as the proxy', 'benchmarkKind': 'proxy'},
    'WEPN': {'benchmark': 'ITA', 'benchmarkName': 'Aerospace and defense (ITA), used as the proxy', 'benchmarkKind': 'proxy'},
    'DRMY': {'benchmark': 'SMH', 'benchmarkName': 'Semiconductors (SMH), used as the proxy', 'benchmarkKind': 'proxy'},
    'YRAM': {'benchmark': 'SMH', 'benchmarkName': 'Semiconductors (SMH), used as the proxy', 'benchmarkKind': 'proxy'},
    'MINY': {'benchmark': 'XME', 'benchmarkName': 'Metals and mining (XME), used as the proxy', 'benchmarkKind': 'proxy'},
    'YYY': {'benchmark': 'SPY', 'benchmarkName': 'S&P 500 (SPY), used as the proxy', 'benchmarkKind': 'proxy'},
